...
export default function Profile() {
  ...
  return (
    <div className="bg-slate-50 w-full p-10 px-60 min-h-screen text-dark">
      <div className="flex justify-center items-start bg-gray-100 rounded-md shadow-md py-6 px-4 ">
